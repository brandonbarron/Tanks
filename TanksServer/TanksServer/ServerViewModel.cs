...
namespace TanksServer
{
    public class ServerViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private readonly ComLogic.MainServerLogicForMainServer _mainServerLogic;
        ...
        private void StartServer()
        {
            ...
            //t.Start();
            _mainServerLogic.SetListeningPort(ServerPort);
            _mainServerLogic.StartServer();
        }

        private void StopServer()
        {
            //_cancellationTokenSource.Cancel();
            _mainServerLogic.StopServer();
        }

        private void _mainServerLogic_SocketEventInfo(string socketEvent)
        {
            Application.Current.Dispatcher.Invoke(() => ServerStatus = socketEvent, DispatcherPriority.Background);
        }

        private void _mainServerLogic_ReceivedDataLog(string logString)
        {
        ...
        private void _mainServerLogic_NewGameServerConnected(TanksCommon.SharedObjects.GameServerRegister gameServer)
        {
